...
export default async function EditMovieBillingHeadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <PageHeader title={`Edit Billing Head · ${head.name}`} description="Update client-specific billing head details." actions={<Link href="/client-billing-heads" className="btn-secondary">Back to Billing Heads</Link>} />
