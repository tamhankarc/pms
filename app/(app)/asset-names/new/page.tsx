...
export default async function NewAssetNamePage() {
  ...
  return <div className="space-y-6"><PageHeader title="Create Asset Name" description="Create a Universal Pictures International asset name." actions={<Link href="/asset-names" className="btn-secondary">Back to Asset Names</Link>} /><div className="max-w-3xl"><AssetNameForm action={createAssetNameAction} title="Create Asset Name" submitLabel="Create Asset Name" /></div></div>;
}
