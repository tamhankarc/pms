...
export default async function NewMovieBillingHeadPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <PageHeader title="Create Title Billing Head" description="Assign a Fixed - Optional billing head to a Working title for the selected country." actions={<Link href="/movie-billing-heads" className="btn-secondary">Back to Title Billing Heads</Link>} />
