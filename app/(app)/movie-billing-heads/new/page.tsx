...
export default async function NewMovieBillingHeadPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-6"><PageHeader title="Create Movie Billing Head" description="Create a client-specific movie billing head." actions={<Link href="/movie-billing-heads" className="btn-secondary">Back to Billing Heads</Link>} /><MovieBillingHeadForm clients={clients} action={createMovieBillingHeadAction} title="Create billing head" submitLabel="Create billing head" /></div>;
}
