...
export default async function NewMoviePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <MovieForm clients={clients} countries={countries} billingHeads={billingHeads} action={createMovieAction} title="Create movie" submitLabel="Create movie" canEditCosts={canViewCostData(currentUser)} />
    </div>
  );
}
