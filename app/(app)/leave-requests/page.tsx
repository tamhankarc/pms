    ...
    <div className="space-y-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-700">
            ...
            <span className="ml-2 font-semibold text-slate-900">
              {data.leaveBalance.casualLeaves.toFixed(2)}
            </span>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-700">
            Earned leaves remaining{" "}
            <span className="ml-2 font-semibold text-slate-900">
              {data.leaveBalance.earnedLeaves.toFixed(2)}
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="table-wrap">
        <div className="border-b border-slate-200 px-6 py-5">
          ...
          <p className="section-subtitle">
            Current includes active dates and all requests that are still
            actionable.
          </p>
        </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {row.status === "RECONSIDER" ? (
                      <Link
                        ...
                        href={`/leave-requests/${row.id}/edit`}
                      >
                        Edit
                      </Link>
                    ) : null}
      ...
      <section className="table-wrap">
        <div className="border-b border-slate-200 px-6 py-5">
          ...
          <p className="section-subtitle">
            Past includes inactive requests whose dates have passed or which are
